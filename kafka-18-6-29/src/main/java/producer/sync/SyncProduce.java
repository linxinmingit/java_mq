...
public class SyncProduce {
	public static void main(String[] args) {
        ...
        props.put("metadata.broker.list", "192.168.1.8:9092,192.168.1.9:9092,192.168.1.10:9092"); // 主机地址+端口号
       ...
       //props.put("auto.offset.reset", "smallest");
        ...
        for (long nEvents = 0; nEvents < events; nEvents++) { 
               ...
               KeyedMessage<String, String> data = new KeyedMessage<String, String>("liuwen", ip, nEvents+"");
